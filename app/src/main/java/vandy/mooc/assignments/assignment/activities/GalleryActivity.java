...
public class GalleryActivity
    ...
    public static Intent makeStartIntent(
        ...
        Log.i(TAG, "makeStartIntent created");
        ...
        Log.i(TAG, "makeStartIntent url packed into the intent");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            List<Uri> urls = extractInputUrlsFromIntent(intent);
            if (urls != null) {
                setItems(urls);
            }
    ...
    private List<Uri> extractInputUrlsFromIntent(Intent intent) {
        ...
        ArrayList<Uri> res = intent.getParcelableArrayListExtra(INTENT_EXTRA_URLS);
        if (validateInput(res)) {
            Log.i(TAG, "extractInputUrlsFromIntent, the entire list of received url is valid");
            return res;
        } else {
            Log.e(TAG, "extractInputUrlsFromIntent, the entire list of received url is not valid");
            return null;
        }
